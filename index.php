...
<html>
<head>
<title>Launch Page: Dungho Dog Character Generator</title>
...
<body>
	...
	<section>
        ...
        <br/>
            ...
            <br/>    
			<form action="" id ="dunghoForm"  target="_blank" method="post">
		...
		<div class="content8">
			  ...
			  <select id="level" class="dropdownmenu2Iconic">
				<option value="01" selected>Dungho Dog, Level 1</option>
				<option value="02">Dungho Dog, Level 2</option>
				<option value="03">Dungho Dog, Level 3</option>
				<option value="04">Dungho Dog, Level 4</option>
				<option value="05">Dungho Dog, Level 5</option>
				<option value="06">Dungho Dog, Level 6</option>
				<option value="07">Dungho Dog, Level 7</option>
				<option value="08">Dungho Dog, Level 8</option>
				<option value="09">Dungho Dog, Level 9</option>
				<option value="10">Dungho Dog, Level 10</option>
			  </select>
        ...
        {
            $("#dunghoForm").attr('action', "dungho/dungho"+ $("#level").val() +  ".php");
        });
